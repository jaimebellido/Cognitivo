...
install.packages("descr") # Instala o pacote para a visualização de tabelas de frequencias
library(descr)


freq(round(listings2$reviews_per_month), digits=2)
...
View(listings3)
freq(round(listings3$reviews_per_month), digits=2)
...
![](C:/Users/jaime.bellido/AppData/Local/RStudio/tmp/paste-1DE25054.png)
